...
class GUI(QMainWindow, Ui_MainWindow):
    ...
    #             if self.sensor_controller.sensor_id is None:
    #                 raise Exception('self.sensor_id is None')
    #
    #             self.label_data.set_sensor_id(self.sensor_controller.sensor_id)
    #
    ...
    #
    #         # run the classifier
    #         self.ml_dataframe = self.sensor_controller.sensor_data.__copy__()
    #         self.ml_dataframe.add_timestamp_column(COL_TIME, COL_TIMESTAMP)
    #         labels = self.plot_controller.label_manager.get_labels_by_file_and_date(self.sensor_controller.sensor_id,
    #                                                                                 self.sensor_controller.utc_dt.date())
    ...
    #             start = (start_dt - self.sensor_controller.utc_dt).total_seconds()
    #             end = (end_dt - self.sensor_controller.utc_dt).total_seconds()
    #
    ...
    #                 self.timer.stop()
    #                 self.plot_controller.update_plot_axis(position=start + self.doubleSpinBox_video_offset.value())
    #
    ...
    #                 self.plot_controller.label_manager.add_label(start_dt, end_dt, label, self.sensor_controller.sensor_id)
    ...
    #             self.timer.start(25)
    #
    #         self.plot_controller.update_plot_axis(position=original_position / 1000)
