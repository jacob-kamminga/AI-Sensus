...
class LabelSettingsDialog(QtWidgets.QDialog, Ui_Dialog):
    ...
    def __init__(self, label_manager: LabelManager, label_type_manager: LabelTypeManager, settings: Settings):
        super().__init__()
        self.setupUi(self)
    ...
    def add_label(self):
        ...
        if self.lineEdit_new_label.text():
            self.label_type_manager.add_label_type(self.lineEdit_new_label.text(),
