...
settings_file_name = "settings_dict.pkl"
...
def new_project(project_name: str) -> None:
    ...
    if not os.path.exists('projects/' + project_name):
        ...
        LabelManager(project_name).create_table()
        SensorUsageManager(project_name).create_table()
...
class Settings:
    ...
    def __init__(self, project_name: str, is_new_project: bool=False):
        ...
        :param is_new_project: Boolean indicating if a new settings_dict file should be generated
        """
    ...
    def _get_path(self) -> str:
        """
        Returns the path to the settings_dict file relative to the root directory

        :return: The path to the settings_dict file
        """
